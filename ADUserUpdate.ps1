...
$CsvFile = "C:\AccountUpdate\ADUser.csv"
$LogFile = "C:\AccountUpdate\ADUser Log "+$DateTime+".log"
...
$Fields = @("employeeID", "pwdLastSet", "DisplayName", "department")
...
$Version = "Version 1.0 - July 17, 2020 Last Updated by Shawn Yeh"
...
Add-Content -Path $LogFile -Value "================================================" `
    -ErrorAction Stop
Add-Content -Path $LogFile -Value "ADUserUpdate.ps1"
